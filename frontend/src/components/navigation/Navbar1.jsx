...
import { FiHome, FiCalendar, FiPieChart, FiMoon, FiSun, FiTarget, FiClock } from 'react-icons/fi';
        ...
        <div className="navbar-right">
          ...
          <div className="profile-section">
            <div className="profile-button" onClick={toggleProfileMenu}>
              <span className="profile-initial">{currentUser.initial}</span>
            </div>
            {isProfileOpen && (
              <div className="profile-dropdown">
                <div className="profile-info">
                  <div className="profile-info-initial">{currentUser.initial}</div>
